...
try
{
    ...
    {
        throw "Direct install and SmokeTest are disabled for PekVueZero.Template. Use Templates\\PeiKeSmart.Template.Bundle\\pack-template.ps1 -Install or -Install -SmokeTest instead."
    }
